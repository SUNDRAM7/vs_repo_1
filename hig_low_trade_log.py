...
# === CONFIGURATION === #
CSV_FOLDER = r"C:\Users\Axxela\Desktop\New folder"
OUTPUT_FOLDER = r"C:\Users\Axxela\Desktop\trade_log_high_low"
FIXED_TARGET = 0.05
...
class OptionTracker:
    ...
    def add_straddle(self, call_strike, put_strike, entry_time, call_bid, put_bid):
        ...
        call_sl = (float(min(call_bid * 2, call_bid + put_bid)))#stoploss ke ticks ka 50%
        put_sl =  (float(min(put_bid * 2, call_bid + put_bid)))
