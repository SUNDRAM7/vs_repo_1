...
DB_CONFIG = {
    ...
    "user": "root",
    "password": "Axxela@123",
    "database": "snp500_bbo_data"
}

CSV_FOLDER_PATH = r"C:\Users\Axxela\Desktop\OPRA-20250701-4JRUGBH6X9"  # Update this
BATCH_SIZE = 50000  # Reduce from 1,00,000 to prevent MySQL disconnects
